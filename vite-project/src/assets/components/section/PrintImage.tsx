...
const ImageToPrint = () => {
    ...
    return (
        <main>
            ...
            <SingleImage singleImageAll={null} singleImagePrint={singleImagePrint} singleImageAllName={null} singleImagePrintName={singleImagePrintName} onClose={() => setSingleImagePrint(null)}  />
        </main>
