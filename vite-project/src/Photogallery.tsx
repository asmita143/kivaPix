  ...
  return (
    <div className="app-container"> 
      ...
      <div className="flex h-screen bg-gray-100 ">
        ...
        >
          <div className="mt-3  divide-y divide-light-black-800 flex-col max-h-screen overflow-y-auto bg-white">
            {/* Fixed Header */}
            <div className="bg-green-500 flex p-4 w-full justify-between sticky top-0 z-10 shadow-lg rounded-lg">
              <div >
